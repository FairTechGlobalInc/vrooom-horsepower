...
<head>
    ...
    <script type="text/javascript">
        ...
        function clear_cart() {
            ...
            if (result) {
                window.location = "<?php echo base_url(); ?>index.php/Rentalcontroller/remove/all";
            } else {
...
// Create form and send all values in "shopping/update_cart" function.
                echo form_open('Rentalcontroller/update_cart');
                $grand_total = 0;
                $i = 1;
...
// <input type="hidden" name="cart[1][id]" value="1" />
                    ...
                    <td>
                        ...
                        <?php
                        // cancel image.
                        $path = "<img src='http://localhost/ndai/assets/images/cart_cross.jpg' width='25px' height='20px'>";
                        echo anchor('Rentalcontroller/remove/' . $item['rowid'], $path); ?>
                    </td>
                <?php endforeach; ?>
                </tr>
                <tr>
                    ...
                    <td colspan="5" align="right"><input  class ='fg-button teal' type="button" value="Clear Cart" onclick="clear_cart()">
                        ...
                        <input class ='fg-button teal' type="button" value="Place Order" onclick="window.location = 'Rentalcontroller/billing_view'"></td>
                </tr>
            <?php endif; ?>
        </table>
    </div>
        ...
        foreach ($products as $product) {
            ...
            <div id='product_div'>
                ...
                <div id='info_product'>
                    ...
                    echo form_open('Rentalcontroller/add');
